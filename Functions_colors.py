...
cellsFunction = {"Macrophage" : ["Kill enemies", "Cause inflammation", "Activate other cells", "Communicate"],
    ...
    "Dendritic cell" : ["Activate other cells", "Strategic decisions"], # why does the video chow it defferently as [6, 9]???
    "Memory helper T cell" : ["Activate other cells", "Remember enemies", "Communicate"],
    "Bosophil" : [],
    "Eosinophil" : [],
    "Virgin helper T cell" : ["Standby mode", "Activate other cells"],
    "Helper T cell" : ["Activate other cells", "Communicate"],
    ...
    "Memory killer T cell" : ["Activate other cells", "Remember enemies"],
